    ...
    try:
        ...
        for item in records:
            ...
            if last_price is None:
                ...
                should_save = False # Giá không đổi -> Bỏ qua, không lưu rác
        ...
        cur.close()
        conn.close()
        print(f"iNet: Quét xong. Có {inserted_count} sản phẩm thực sự thay đổi giá được lưu vào DB.")
    except Exception as e:
        print(f"Lỗi DB iNet: {e}")
